...
-- AddForeignKey
ALTER TABLE "Generation" ADD CONSTRAINT "Generation_generationId_fkey" FOREIGN KEY ("generationId") REFERENCES "Generation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
